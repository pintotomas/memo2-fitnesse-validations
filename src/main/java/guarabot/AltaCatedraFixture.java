...
public class AltaCatedraFixture extends JsonFixture {

    private static final String ERROR_INESPERADO = "ERROR_INESPERADO";

    protected final static String ALTA_CATEDRA_PATH = "catedras";

    public AltaCatedraFixture() throws IOException {
